...
that does not follow a \grammarterm{nested-name-specifier} or
...
\item
when a prvalue that has type other than \cv{}~\keyword{void} appears as a discarded-value expression\iref{expr.prop}.
\end{itemize}
\end{note}
\begin{example}
...
An object of type \cv{}~\tcode{\keyword{void}*}
shall have the same representation and alignment
requirements as \cv{}~\tcode{\keyword{char}*}.
...
\keyword{char}} (if \keyword{char} is signed) shall have the same rank, even if they have
the same representation.

\item The rank of a signed integer type shall be greater than the rank
of any signed integer type with a smaller width.

\item The rank of \tcode{\keyword{long} \keyword{long} \keyword{int}} shall be greater
than the rank of \tcode{\keyword{long} \keyword{int}}, which shall be greater than
the rank of \keyword{int}, which shall be greater than the rank of
\tcode{\keyword{short} \keyword{int}}, which shall be greater than the rank of
...
\item The rank of \keyword{char} shall equal the rank of \tcode{\keyword{signed} \keyword{char}}
and \tcode{\keyword{unsigned} \keyword{char}}.

\item The rank of \keyword{bool} shall be less than the rank of all other
...
\keyword{wchar_t} shall equal the ranks of their underlying
...
\item a function of \tcode{(\keyword{int}}, pointer to pointer to \keyword{char)} returning \keyword{int}
\end{itemize}
