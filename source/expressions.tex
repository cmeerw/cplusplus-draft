...
is an implicit \tcode{(*\keyword{this})}~(\ref{class.mfct.non-static}).
\end{footnote}
...
(\ref{expr.prim.id.qual}, \ref{dcl.type.simple}, \ref{dcl.type.elab},
\ref{dcl.mptr}, \ref{namespace.udecl}, \ref{temp.param}, \ref{temp.names},
\ref{temp.res}).
\end{note}
...
\indextext{type!incomplete}%
This return type shall be an object type, a reference type or \cv{}~\keyword{void}.
...
\keyword{delete} may be a null pointer value, a pointer to a non-array object
